...
- Cleaned up the journal structure: instead of one giant file, I moved entries into `00-blog/` as individual dated files (`YYYY-MM-DD.md`).  
...
- I structured the repo as `docs/00-blog/YYYY-MM-DD.md` yesterday and decided to publish with **MkDocs + GitHub Pages**.
