...
- Cleaned up the journal structure: instead of one giant file, I moved entries into `00-archive/` as individual dated files (`YYYY-MM-DD.md`).  
...
- I structured the repo as `docs/00-archive/YYYY-MM-DD.md` yesterday and decided to publish with **MkDocs + GitHub Pages**.
